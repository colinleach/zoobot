...
def get_labels():
    ...
    labels = matching_df['label'].astype(int).values
    counts = matching_df['total_votes'].astype(int).values
...
if __name__ == '__main__':
    ...
    subject_ids = list(unlabelled_catalog['id_str'][:100].astype(str))  # entire unlabelled catalog!
