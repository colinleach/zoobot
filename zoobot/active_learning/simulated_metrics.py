...
class SimulatedModel():
    ...
    def __init__(self, model, full_catalog, bin_probs=None):
        ...
        self.mean_prediction = self.model.samples.mean(axis=1)
    ...
    def acquisitions_vs_mean_prediction(self, n_acquired, save_dir):
        acquisitions_vs_values(self.model.acquisitions, self.mean_prediction, n_acquired, 'Mean Prediction', save_dir)
