...
`dvc run -d $catalog_loc -d zoobot/active_learning/make_shards.py -o $shard_dir -f make_shards_bar_full.dvc python zoobot/active_learning/make_shards.py --shard_dir=$shard_dir --catalog_loc=$catalog_loc`
