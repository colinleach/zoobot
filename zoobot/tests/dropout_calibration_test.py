...
@pytest.fixture()
def n_subjects():
    return 3000  # more subjects decreases coverage variation between each confidence level


@pytest.fixture()
def n_samples():
    return 2000  # more samples decreases systematic offset on coverage vs confidence (from pymc3)
