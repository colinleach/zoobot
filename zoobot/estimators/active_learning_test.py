...
#
# from zoobot.estimators import active_learning
#
# logging.basicConfig(
...
# @pytest.fixture()
# def model_fn():
#     return four_layer_regression_classifier
#
#
# def test_run_experiment(model_fn, params):
#     active_learning.run_active_learning(model_fn, params)
