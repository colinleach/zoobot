...
#     fi
    ...
    $PYTHON zoobot/active_learning/run_iteration.py --instructions-dir=$INSTRUCTIONS_DIR --this-iteration-dir=$THIS_ITERATION_DIR --previous-iteration-dir=$PREVIOUS_ITERATION_DIR $OPTIONS
    # stop if any error
    RESULT=$?
    if [ $RESULT -gt 0 ]
    then
