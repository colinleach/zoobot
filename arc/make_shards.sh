...
# 80% split w/ decals
$PYTHON zoobot/active_learning/make_shards.py --labelled-catalog=data/decals/prepared_catalogs/$CATALOG_NAME/labelled_catalog.csv --unlabelled-catalog=data/decals/prepared_catalogs/$CATALOG_NAME/unlabelled_catalog.csv --eval-size 49700 --shard-dir=data/decals/shards/${CATALOG_NAME}_train_labelled  --img-size 300
